      ...
      <div className="container">
        <div id="iphone-13" className='transform sm:translate-x-1/4 md:translate-x-2/4 lg:translate-x-full pt-5 sm:w-[428px] h-[926px] bg-[#1B202D] sm:rounded-[50px] shadow-3xl'>
          ...
          <div id="main" className='container px-2 mx-3 mt-10'>
            ...
            <label className="relative block mt-44 sm:mt-36">
              ...
              <input class="placeholder:italic placeholder:text-slate-400 block bg-[#3D4354] w-[96%] sm:w-[376px] h-[46px] rounded-full mt-16 focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm py-2 pl-12 pr-3" placeholder="Message" type="text" name="search" />
            </label>
          </div>
        </div >
      </div>
