  ...
  return (
    <div className="bg-gradient-to-r from-[#7C808C] to-[#4E5158] text-white h-full w-full sm:py-10">
      <div className="container">
        <div id="iphone-13" className='phone-layout'>
          ...
          <div id="main" className='container px-2 sm:mx-3 mt-10'>
            ...
            <div className='py-5 text-send w-2/3 sm:w-1/3 mt-3'>
            ...
            <div className='text-reply w-12 float-right mr-0 sm:mr-6'>
              <p className='genarel-comment-style'>?</p>
            </div>

            <h6 className='py-5 text-center font-normal text-sm'>08:43</h6>

            <div className='py-4 text-send w-3/4 sm:w-[55%] mt-3'>
            ...
            <label className="relative block pb-5 mt-32 sm:mt-32">
              <span className="sr-only">Search</span>
              <span className="absolute inset-y-0 pb-5 left-0 flex items-center pl-3">
              ...
              <span class="absolute pb-5 inset-y-0 sm:ml-[80%] ml-[80%] flex items-center pr-2">
