...
function App() {
  return (
    <div className="bg-gradient-to-r from-[#7C808C] to-[#4E5158] text-white h-full w-full py-10">
      <div id="iphone-13" className='transform translate-x-full pt-5 w-[428px] h-[926px] left-[517px] top-[129px] bg-[#1B202D] rounded-[50px] shadow-3xl'>
        {/* <div id="status-bar" className=' w-96 flex justify-around items-center'>
          <div id="service" className='flex flex-row items-center p-0 gap-1 w-24 h-3'>
        <h4 className='font-serif text-sm leading-[100%] tracking-tight text-white font-[500px]'>Service</h4>
        <h4 className='text-white'>LTE</h4>
      </div>
      <div id="time">
        <h4 className='w-8 left-[40%]'>19:02</h4>
      </div>
      <div id="battery" className=''>
        <h4 className='w-8 left-[40%]'>battery</h4>
      </div>
    </div> */}
        ...
        <div id="main" className='container px-2 mx-3 mt-10'>
          ...
          <div id="text-send" className='text-send'>
          ...
          <div id="text-send" className='py-4 text-send w-1/3 mt-3'>
          ...
          <div id="text-reply" className='text-reply w-12 ml-[340px]'>
          ...
          <label class="relative block">
            ...
            <span class="absolute inset-y-0 right-12 flex items-center pr-2">
            ...
            <input class="placeholder:italic placeholder:text-slate-400 block bg-[#3D4354] w-[376px] h-[46px] rounded-full mt-20 focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm py-2 pl-12 pr-3" placeholder="Message" type="text" name="search" />
          </label>
        </div>
      </div >
    </div >
